...
For detailed VPS installation steps (system prerequisites, Tailscale auth key setup, systemd service, firewall rules, and ACME/SSL configuration), see INSTALL.md:

[INSTALL.md](./docs/INSTALL.md)

This file contains step‑by‑step instructions and example commands for Ubuntu/Debian deployments.
